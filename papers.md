...
<div class="container">
  <div id="timeline">
    ...
    <div id="theorypapers" class="timelineitem">
      ...
      <div id="ttitle" onClick="showDetails('nn_crypto')">
      ...
      <div id="nn_crypto" style="display:none;">
        ...
        <div class="tcontent">
          ...
          <div class="tdesc">
            <p>
              This is an awesome proof-of-concept paper. Though not strictly theoretical, the paper proves that neural networks can, "learn to use secret keys to protect information from other neural networks." This is a very interesting property in its own right. Furthermore, while these results are not immediately applicable, they could become very important in the long term.</p>
            <p>
              TODO: another paragraph goes here
            </p>
          </div>
        </div>
      </div>
