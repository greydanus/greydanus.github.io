...
<div class="imgcap" style="display: block; margin-left: auto; margin-right: auto; width:99.9%">
  <div style="width:53%; min-width:200px; display: inline-block; vertical-align: top;">
    ...
    <div style="text-align: left;">A beautiful figure from Otto Lilienthal's book <i>The Flight of Birds as the Basis of the Art of Flying</i>. Lilienthal spent years studying the aerodynamics of bird wings in preparation for his glider project.</div>
  </div>
  <div style="width:45%; min-width:200px; display: inline-block; vertical-align: top;">
    <img src="/assets/stepping-stones/compare_airfoils.png" style="width:100%">
