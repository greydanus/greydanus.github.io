...
And one might think that even if an individual can function this way, a society probably cannot...
...
That’s the story of the 1920’s and 1930’s, which is when the mathematical theory of flight got started. Physicists finally had the time to come up with theories that explained experimental results. They used these theories to make airfoils better in small but important ways. These ideas culminated in the 1933 NACA Report 460 which set the industry standard for the next several decades. Some of the airfoils in that report, like the NACA 2412, are still in use today. Many World War II planes used those designs too. Good examples include the DC-3 transport plane and the B-17 Flying Fortress.[^fn9]
...
The process of minor improvements based on theory continued into the 1940’s, when NACA researchers invented the laminar flow airfoil and installed it on the P-51 Mustang. This airfoil was important because it was one of the first innovations based on theory rather than experiment.[^fn9] In practice, the laminar flow correction was rather small and it led to modest improvements. It did, however, represent a philosophical shift in the way wings were designed, with greater emphasis being placed on physics than human intuition. Focusing on the causal mechanisms of flight ended up being crucial to later innovations in the supersonic regime since the way air behaves at those speeds isn't as intuitive.
...
If intuition and imagination are the first immigrants to a new land, then formal scientific work is like the nation that follows. In the past century, scientists have constructed such a nation around the idea of flight. This nation is built on physical principles like "computational fluid dynamics", "aeronautical science", and "turbulent flow." Such principles are quite complex, but the question they aim to answer is simple: _how does flight work?_

Today, one can use these principles to derive an entire airplane wing more or less from scratch. In fact,  I’m going to do just that in the next section, using nothing but the physics of flight...
...
Here is a complete timeline of the airfoils we discussed in this article. I've also added the Boeing 747 airfoil, which I touch on briefly in the next post. I obtained the outlines from primary sources and they are technically accurate – or close 🤷‍♂️.
